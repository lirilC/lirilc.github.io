...
var user= {
    ...
    ties: [
        ["Padre de", {name: "#Satanás Belcebú"}],
        ["Padre de", {name: "#Jesús De Nazareth"}],
        ["Abuelo de", {username: "MeganFox", name: "Megan Denise Fox", tool: `<div class='tool'>
                                                                                            <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Abuelo de", {username: "A.K.A._Dizzy", name: "Luis Eduardo Gallego García", tool:   `<div class='tool'>
                                                                                                <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Bisabuelo de", {username: "PpP", name: "La Perrita Del Poste", tool:    `<div class='tool'>
                                                                                        <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Bisabuelo de", {username: "Eld", name: "ElDelprincipio", tool:      `<div class='tool'>
                                                                                    <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
