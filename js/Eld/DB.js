...
var user= {
    ...
    ties: [
        ["Nieta de", {name: "#Satanás Belcebú"}],
        ["Sobrina de", {username: "MeganFox", name: "Megan Denise Fox", tool: `<div class='tool'>
                                                                                            <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Sobrina de", {name: "#Ashley Isabel Marín Gallego"}],
        ["Hija de", {username: "L", name: "Laura Escobar Bonnett", tool:   `<div class='tool'>
                                                                                <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Hija de", {username: "A.K.A._Dizzy", name: "Luis Eduardo Gallego García", tool:   `<div class='tool'>
                                                                                                <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Hermanita de", {username: "PpP", name: "La Perrita Del Poste", tool:    `<div class='tool'>
                                                                                        <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Bisnieta de", {username: "G-Suschrist", name: "Dios Jesucristo", tool:   `<div class='tool'>
                                                                                            <input class='knob button' data-width='102' data-height='102' data-fgColor='#2ecc71' data-bgColor='rgba(0,0,0,0)' data-displayInput=false data-thickness='.08' readonly value='100'>
        ...
        ["Nieta biológica de", {name: "#Amparo Del Rosario García Arias"}],
        ["Nieta biológica de", {name: "#Luis Fernando Gallego Echeverri"}],
        ["Sobrina biológica de", {name: "#María Isabel Gallego García"}],
        ["Sobrina biológica de", {name: "#Miguel Ángel Gallego García"}]
    ],
    fotos: {
        quantity: 1,
        fotos: {
